...
3. 在 Cursor 设置 → **MCP** → 添加 Server：
   ...
   ```json
   {
     "mcpServers": {
       "vibe-ui": {
         "command": "node",
        // args 指向您本地构建出来的 mcp-server 入口 JS 文件的绝对物理路径。
        // macOS 示例: "/Users/yourname/code/vibe-ui-web/mcp-server/dist/index.js"
        // Windows 示例: "C:\\Users\\yourname\\code\\vibe-ui-web\\mcp-server\\dist\\index.js"
        "args": ["/Users/yourname/code/vibe-ui-web/mcp-server/dist/index.js"],
         "env": {}
       }
     }
   }
